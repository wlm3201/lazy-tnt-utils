...
/**
 * TNT 动量矢量的绘制方式（纯客户端渲染，持久化到 lazytntutils-client.properties）。
 *
 * <p>按 F3+B 开启碰撞箱时绘制（见 EntityHitboxDebugRendererMixin）。原版自己的速度矢量是「线段 + 箭头」， 生电在观察长距离高速抛 TNT
 * 时，箭头那一小撮尖端会盖住弹道末端的位置判断，因此多给一个只画线段的选项。
 */
